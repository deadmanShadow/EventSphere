  ...
  const faqItems = [
    {
      ...
      answer: "EventSphere is a platform that connects people who want to participate in local events, sports, or hobbies but don't have companions. Whether it's concerts, hiking trips, or meetups, you can find like-minded people to join you."
    },
    {
    ...
    {
      question: "How do I stay safe on EventSphere?",
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
      <div className="text-center mb-10">
        <h2 className="text-3xl font-primary font-medium text-gray-900 mb-3">Frequently Asked Questions</h2>
        <p className="text-gray-600 font-secondary">Find answers to common questions about EventSphere</p>
      </div>
      ...
      <div className="mt-10 text-center">
        ...
        <a
          href="mailto:eventSphere@info.com"
