  ...
  const reviews = [
    {
      ...
      text: "EventSphere made our marketing workshop smooth and stress-free. The platform is easy to use, and helped us connect with participants instantly.",
    },
    {
      id: 2,
      name: "Daniel Carter",
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center px-4">
        ...
        <div>
          ...
          <p className="text-gray-500 font-secondary max-w-md leading-relaxed">
            EventSphere has made planning and managing events so much easier.
